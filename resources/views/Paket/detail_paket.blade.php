              ...
              <div class="card p-2 shadow-lg">
                  <table class="table table-bordered">
                      <tbody>
                        <tr>
                          <td>Spesifikasi</td>
                        <td><a href="{{route('paket.detail.spek',['id'=>$paket->id])}}" class="badge badge-info">Input Spesifikasi</a></td>
                          
                        </tr>
                        <tr>
                          <td>(HPS)</td>
                          <td><a href="{{route('paket.detail.hps',['id'=>$paket->id])}}" class="badge badge-info">Isi HPS</a></td>
