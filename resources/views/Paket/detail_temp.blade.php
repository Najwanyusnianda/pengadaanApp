                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="list-group">
                                        <li class="list-group-item">
                                            ...
                                            <a href="{{route('doc.spekTeknis',['id'=>$paket->id])}}"><span class="badge badge-secondary">download</span></a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="list-group">
                                        <li class="list-group-item">
                                                @if ($is_not_penawaran >0)
                                                <i class="fas fa-check-circle mr-2 text-success"></i> 
                                                @endif
                                            Jadwal Penawaran: <a href="{{route('paket.detail.jadwal_penawaran',['id'=>$paket->id])}}">
                                                <span class="badge badge-secondary">Buat Jadwal Penawaran</span></a>
                                        </li>
                                </div>
                                <hr>
                                <div class="list-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="list-group">
                                        <li class="list-group-item">Surat Perintah Mulai Kerja</li>
                                    <li class="list-group-item">Surat Perintah Kerja</li>
                                </div>
                            </td>
                        </tr>
